...
public class Web extends Base {
    ...
    public void checkMenuBar(){
        clickByXpath("//XCUIElementTypeOther[@name=\"Global, navigation\"]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[1]");
    }
    public void checkAppleLogo(){
        clickByXpath("//XCUIElementTypeOther[@name=\"Global, navigation\"]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[2]");
    }
    public void checkShoppingBag(){
        clickByXpath("/XCUIElementTypeButton[@name=\"Shopping Bag\"]");
    }
    public void checkLimitedTime(){
        clickByXpath("//XCUIElementTypeStaticText[@name=\"Limited time\"]");
    }
    ...
    public void checkTradingIPhone(){
        clickByXpath("//XCUIElementTypeStaticText[@name=\"Trade in your current iPhone and upgrade to a new one.\"]");
    }
    ...
    public void checkTextIPhoneXR(){
        clickByXpath("//XCUIElementTypeOther[@name=\"All-screen design. Longest battery life ever in an iPhone. Fastest performance. Studio-quality photos.\"]");
    }
